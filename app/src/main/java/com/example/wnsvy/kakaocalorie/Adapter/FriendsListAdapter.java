...
import com.example.wnsvy.kakaocalorie.Utils.CircularNetworkImageView;
...
public class FriendsListAdapter extends BaseAdapter {
    ...
    private class ViewHolder {
        CircularNetworkImageView profileView; // volley.toolbox.NetworkImageView 원형 버전 커스텀 클래스
        TextView nickName;
    }
    private List<AppFriendInfo> items = null;

    public FriendsListAdapter(List<AppFriendInfo> items, IFriendListCallback listener) {
        this.items = items;
        this.listener = listener;
    }

    public void setItem(List<AppFriendInfo> items) {
        this.items = items;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String nickName = String.valueOf(position) + "번 친구 " + info.getProfileNickname();
